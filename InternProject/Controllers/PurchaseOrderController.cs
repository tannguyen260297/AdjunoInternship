...
namespace InternProject.Controllers
{
    public class PurchaseOrderController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,OrderDate,Buyer,Currency,Season,Department,Vendor,Company,Origin,PortOfLoading,PortOfDelivery,OrderType,Factory,Mode,ShipDate,LatestShipDate,DeliveryDate,POQuantity,Status")] AddModel addModel)
        {
            if (ModelState.IsValid)
            {
                db.AddModels.Add(addModel);
                db.SaveChanges();
